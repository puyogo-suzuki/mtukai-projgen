...
use super::{UseInfo, UnusedItem, UnusedItemKind, UnusedAnalysisResult, use_elimination};
...
impl AstCollectFile {
    ...
    pub(super) fn new_from_file(file: &ra_ap_syntax::SourceFile, unresolved_imports: Vec<UseInfo>, features: &Vec<String>) -> AstCollectFile {
        ...
        fn insert_to_functions(functions: &mut HashMap<String, (ra_ap_syntax::ast::Fn, AstVisitInfo)>, func: &ra_ap_syntax::ast::Fn, features: &Vec<String>) {
...
impl AstCollect {
    ...
    pub(super) fn collect_from_file(&mut self, file_id : &ra_ap_vfs::FileId, db : &RootDatabase, root_krate : &ra_ap_hir::Crate, disabled_optional_deps: &HashSet<String>, features : &Vec<String>) {
